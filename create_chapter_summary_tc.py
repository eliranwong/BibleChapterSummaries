import sqlite3
import os, apsw, re
from agentmake import agentmake, readTextFile
from agentmake.plugins.uba.lib.BibleParser import BibleVerseParser
from biblemate import AGENTMAKE_CONFIG
from agentmake import agentmake

DATABASE_NAME = 'ai_chapter_summary_tc.db'
        ...
        for i in range(1, 67):
            ...
            while fetches or c == 1:
                ...
                try:
                    ...
                    system = readTextFile(os.path.join(os.getcwd(), "system.md"))
                    system += "\n\n# Response Language\n\nTraditional Chinese 繁體中文\n\n请使用繁體中文作所有回應，除了引用工具名稱或希伯來語或希臘語，或我特别要求你使用英文除外。"
                    response = agentmake(content, system=system)[-1]["content"]
                    if response:
                        response = re.sub("([^ ])([0-9]+?[:：][0-9])", r"\1 \2", response)
